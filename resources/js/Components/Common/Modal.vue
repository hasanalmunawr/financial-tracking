...
<template>
    <div v-if="isOpen" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div :class="[
            'rounded-lg shadow-lg w-full max-h-[90vh] overflow-y-auto p-6 transition-colors duration-300',
            'bg-white text-black dark:border-gray-700',
            modalSize
        ]">
            ...
            <div class="flex justify-between items-center border-b pb-3 dark:border-gray-600">
                ...
                <button @click="closeModal" class="text-gray-500 hover:text-red-500 text-2xl dark:text-gray-400 dark:hover:text-red-500">&times;</button>
            </div>
